...
object FakeMediaRepository {
    ...
    /**
     * Hardcoded Media Detail response used by the Media Detail screen.
     */
    ...
    /**
     * Hardcoded reviews for sampleMediaDetail.
     */
    val sampleReviews = listOf(
        Review(
            ...
            mediaId = 1080,
            rating = 5,
            reviewText = "A staggering achievement — bigger, bolder, and more emotional.",
        ...
        Review(
            ...
            mediaId = 1080,
            rating = 4,
            reviewText = "Gorgeous to look at and thunderously scored.",
